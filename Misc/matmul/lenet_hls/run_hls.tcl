...
# tb
add_files -tb tb/test_utils.h
add_files -tb tb/test_conv2d.cpp
add_files -tb tb/test_avg_pool.cpp
add_files -tb tb/test_fc_layer.cpp
add_files -tb tb/test_lenet5.cpp
